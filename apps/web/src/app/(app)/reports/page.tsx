...
const STATS = [
    { label: 'Total Messages', value: '12,480', change: '+8%', up: true, icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
    { label: 'Active Contacts', value: '248', change: '+3%', up: true, icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
    { label: 'Groups Joined', value: '14', change: '+1', up: true, icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
    { label: 'Unread Today', value: '37', change: '-5%', up: false, icon: 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9' },
];
...
export default function ReportsPage() {
    return (
        <div className="flex flex-col h-full bg-gray-50 dark:bg-[#0b0e13] overflow-hidden">
            <MobileNavHeader title="Reports" subtitle="Your activity overview" />
            {/* Desktop header */}
            <div className="hidden md:block px-5 pt-5 pb-4 bg-white dark:bg-[#151a21] border-b border-gray-100 dark:border-[#222838] flex-shrink-0">
                <h1 className="text-[18px] font-bold text-wa-text">Reports</h1>
                <p className="text-[12px] text-wa-textMuted mt-0.5">Your activity overview</p>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                    {STATS.map(s => (
                        <div key={s.label} className="bg-white dark:bg-[#151a21] rounded-2xl p-4 border border-gray-50 dark:border-[#222838]">
                            ...
                            <p className="text-[11px] text-wa-textMuted mt-1">{s.label}</p>
                        </div>
                    ))}
                </div>
                ...
                <div className="bg-white dark:bg-[#151a21] rounded-2xl p-4 border border-gray-50 dark:border-[#222838]">
                    <div className="flex items-center justify-between mb-4">
                        <p className="text-[14px] font-bold text-wa-text">Weekly Activity</p>
                        <span className="text-[11px] text-wa-textMuted bg-gray-50 dark:bg-[#1e2535] px-2.5 py-1 rounded-lg">This Week</span>
                    </div>

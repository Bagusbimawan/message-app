  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.sub}>Sign in to continue messaging</Text>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <Text style={styles.ghostBtnText}>Create a new account</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  inner:       { flexGrow: 1, paddingHorizontal: 24, paddingTop: height * 0.1, paddingBottom: 48 },
